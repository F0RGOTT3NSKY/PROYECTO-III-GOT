...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_nopt__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div class="line"> </div>
<div class="line">$ node my-program.js --blatzk 1000 -fp # unknown opts are ok.</div>
<div class="line">{ blatzk: 1000, flag: true, pick: true }</div>
<div class="line"> </div>
<div class="line">$ node my-program.js --blatzk true -fp # but they need a value</div>
...
<div class="line"> </div>
<div class="line">$ node my-program.js --many 1 --many null --many foo</div>
<div class="line">{ many: [&quot;1&quot;, &quot;null&quot;, &quot;foo&quot;] }</div>
<div class="line"> </div>
<div class="line">$ node my-program.js --many foo</div>
<div class="line">{ many: [&quot;foo&quot;] }</div>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md5683"></a>
Shorthands</h2>
