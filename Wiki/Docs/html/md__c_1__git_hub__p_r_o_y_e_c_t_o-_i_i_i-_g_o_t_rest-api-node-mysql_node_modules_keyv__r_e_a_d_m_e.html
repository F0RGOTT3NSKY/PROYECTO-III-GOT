...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_keyv__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md5096"></a>
API</h2>
...
<h4><a class="anchor" id="autotoc_md5105"></a>
options.adapter</h4>
<p>Type: <code>String</code><br  />
 Default: <code>undefined</code></p>
...
<h4><a class="anchor" id="autotoc_md5107"></a>
...
<h4><a class="anchor" id="autotoc_md5108"></a>
.get(key)</h4>
<p>Returns the value.</p>
<h4><a class="anchor" id="autotoc_md5109"></a>
.delete(key)</h4>
<p>Deletes an entry.</p>
<p>Returns <code>true</code> if the key existed, <code>false</code> if not.</p>
<h4><a class="anchor" id="autotoc_md5110"></a>
.clear()</h4>
