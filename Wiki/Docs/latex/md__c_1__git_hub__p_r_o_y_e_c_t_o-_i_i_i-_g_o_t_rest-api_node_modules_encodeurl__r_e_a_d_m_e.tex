...
Encode a U\+RL to a percent-\/encoded form, excluding already-\/encoded sequences\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_encodeurl__r_e_a_d_m_e_autotoc_md938}{}\doxysection{Installation}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_encodeurl__r_e_a_d_m_e_autotoc_md938}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_encodeurl__r_e_a_d_m_e_autotoc_md939}{}\doxysection{A\+PI}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_encodeurl__r_e_a_d_m_e_autotoc_md939}

\begin{DoxyCode}{0}
\DoxyCodeLine{var encodeUrl = require('encodeurl')}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_encodeurl__r_e_a_d_m_e_autotoc_md940}{}\doxysubsection{encode\+Url(url)}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_encodeurl__r_e_a_d_m_e_autotoc_md940}
...
This function is {\itshape similar} to the intrinsic function {\ttfamily encode\+U\+RI}, except it will not encode the {\ttfamily \%} character if that is part of a valid sequence, will not encode {\ttfamily \mbox{[}} and {\ttfamily \mbox{]}} (for I\+Pv6 hostnames) and will replace raw, unpaired surrogate pairs with the Unicode replacement character (instead of throwing).\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_encodeurl__r_e_a_d_m_e_autotoc_md941}{}\doxysection{Examples}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_encodeurl__r_e_a_d_m_e_autotoc_md941}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_encodeurl__r_e_a_d_m_e_autotoc_md942}{}\doxysubsection{Encode a U\+R\+L containing user-\/controled data}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_encodeurl__r_e_a_d_m_e_autotoc_md942}
...
\DoxyCodeLine{\})}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_encodeurl__r_e_a_d_m_e_autotoc_md943}{}\doxysubsection{Encode a U\+R\+L for use in a header field}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_encodeurl__r_e_a_d_m_e_autotoc_md943}
...
\DoxyCodeLine{\})}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_encodeurl__r_e_a_d_m_e_autotoc_md944}{}\doxysection{Testing}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_encodeurl__r_e_a_d_m_e_autotoc_md944}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm test}
\DoxyCodeLine{\$ npm run lint}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_encodeurl__r_e_a_d_m_e_autotoc_md945}{}\doxysection{References}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_encodeurl__r_e_a_d_m_e_autotoc_md945}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_encodeurl__r_e_a_d_m_e_autotoc_md946}{}\doxysection{License}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_encodeurl__r_e_a_d_m_e_autotoc_md946}
