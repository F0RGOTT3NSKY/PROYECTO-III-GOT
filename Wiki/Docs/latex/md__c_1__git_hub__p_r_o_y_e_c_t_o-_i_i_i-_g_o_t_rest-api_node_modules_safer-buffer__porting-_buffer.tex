\label{_overview}%
 \hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2810}{}\doxysection{Overview}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2810}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2811}{}\doxysubsection{Finding problematic bits of code using grep}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2811}
Just run `grep -\/nrE '\mbox{[}$^\wedge$a-\/z\+A-\/Z\mbox{]}(Slow)?Buffer\textbackslash{}s$\ast$(\textquotesingle{} --exclude-\/dir node\+\_\+modules\`{}.

It will find all the potentially unsafe places in your own code (with some considerably unlikely exceptions).\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2812}{}\doxysubsection{Finding problematic bits of code using Node.\+js 8}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2812}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2813}{}\doxysubsection{Finding problematic bits of code using linters}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2813}
...
\label{_variant-1}%
 \hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2814}{}\doxysection{Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2814}
...
\label{_variant-2}%
 \hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2815}{}\doxysection{Variant 2\+: Use a polyfill}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2815}
...
\label{_variant-3}%
 \hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2816}{}\doxysection{Variant 3 — manual detection, with safeguards}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2816}
This is useful if you create Buffer instances in only a few places (e.\+g. one), or you have your own wrapper around them.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2817}{}\doxysubsection{Buffer(0)}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2817}
This special case for creating empty buffers can be safely replaced with {\ttfamily Buffer.\+concat(\mbox{[}$\,$\mbox{]})}, which returns the same result all the way down to Node.\+js 0.\+8.\+x.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2818}{}\doxysubsection{Buffer(not\+Number)}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2818}
Before\+:
...
Also note that using Type\+Script does not fix this problem for you — when libs written in {\ttfamily Type\+Script} are used from JS, or when user input ends up there — it behaves exactly as pure JS, as all type checks are translation-\/time only and are not present in the actual JS code which TS compiles to.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2819}{}\doxysubsection{Buffer(number)}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2819}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2820}{}\doxysection{Regarding Buffer.\+alloc\+Unsafe}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2820}
...
\label{_faq}%
 \hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2821}{}\doxysection{F\+AQ}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2821}
\label{_design-flaws}%
 \hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2822}{}\doxysubsection{What is wrong with the $<$tt$>$\+Buffer$<$/tt$>$ constructor?}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2822}
...
\label{_ecosystem-usage}%
 \hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2823}{}\doxysubsection{The $<$tt$>$\+Buffer()$<$/tt$>$ constructor has been deprecated for a while. Is this really an issue?}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_safer-buffer__porting-_buffer_autotoc_md2823}
