\label{_overview}%
 \hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6207}{}\doxysection{Overview}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6207}

\begin{DoxyItemize}
\item \href{\#variant-1}{\texttt{ Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}} ({\itshape recommended})
\item \href{\#variant-2}{\texttt{ Variant 2\+: Use a polyfill}}
\item \href{\#variant-3}{\texttt{ Variant 3\+: manual detection, with safeguards}}
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6208}{}\doxysubsection{Finding problematic bits of code using grep}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6208}
Just run `grep -\/nrE '\mbox{[}$^\wedge$a-\/z\+A-\/Z\mbox{]}(Slow)?Buffer\textbackslash{}s$\ast$(\textquotesingle{} --exclude-\/dir node\+\_\+modules\`{}.

It will find all the potentially unsafe places in your own code (with some considerably unlikely exceptions).\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6209}{}\doxysubsection{Finding problematic bits of code using Node.\+js 8}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6209}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6210}{}\doxysubsection{Finding problematic bits of code using linters}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6210}
Eslint rules \href{https://eslint.org/docs/rules/no-buffer-constructor}{\texttt{ no-\/buffer-\/constructor}} or \href{https://github.com/mysticatea/eslint-plugin-node/blob/master/docs/rules/no-deprecated-api.md}{\texttt{ node/no-\/deprecated-\/api}} also find calls to deprecated {\ttfamily Buffer()} A\+PI. Those rules are included in some pre-\/sets.
...
\label{_variant-1}%
 \hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6211}{}\doxysection{Variant 1\+: Drop support for Node.\+js ≤ 4.\+4.\+x and 5.\+0.\+0 — 5.\+9.\+x.}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6211}
...
Enabling eslint rule \href{https://eslint.org/docs/rules/no-buffer-constructor}{\texttt{ no-\/buffer-\/constructor}} or \href{https://github.com/mysticatea/eslint-plugin-node/blob/master/docs/rules/no-deprecated-api.md}{\texttt{ node/no-\/deprecated-\/api}} is recommended to avoid accidential unsafe Buffer A\+PI usage.

There is also a \href{https://github.com/joyeecheung/node-dep-codemod\#dep005}{\texttt{ J\+S\+Codeshift codemod}} for automatically migrating Buffer constructors to {\ttfamily Buffer.\+alloc()} or {\ttfamily Buffer.\+from()}. Note that it currently only works with cases where the arguments are literals or where the constructor is invoked with two arguments.

{\itshape If you currently support those older Node.\+js versions and dropping them would be a semver-\/major change for you, or if you support older branches of your packages, consider using \href{\#variant-2}{\texttt{ Variant 2}} or \href{\#variant-3}{\texttt{ Variant 3}} on older branches, so people using those older branches will also receive the fix. That way, you will eradicate potential issues caused by unguarded Buffer A\+PI usage and your users will not observe a runtime deprecation warning when running your code on Node.\+js 10.}

\label{_variant-2}%
 \hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6212}{}\doxysection{Variant 2\+: Use a polyfill}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6212}
Utilize \href{https://www.npmjs.com/package/safer-buffer}{\texttt{ safer-\/buffer}} as a polyfill to support older Node.\+js versions.

You would take exacly the same steps as in \href{\#variant-1}{\texttt{ Variant 1}}, but with a polyfill `const Buffer = require(\textquotesingle{}safer-\/buffer').Buffer{\ttfamily in all files where you use the new}Buffer\`{} api.
...
\label{_variant-3}%
 \hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6213}{}\doxysection{Variant 3 — manual detection, with safeguards}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6213}
This is useful if you create Buffer instances in only a few places (e.\+g. one), or you have your own wrapper around them.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6214}{}\doxysubsection{Buffer(0)}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6214}
This special case for creating empty buffers can be safely replaced with {\ttfamily Buffer.\+concat(\mbox{[}$\,$\mbox{]})}, which returns the same result all the way down to Node.\+js 0.\+8.\+x.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6215}{}\doxysubsection{Buffer(not\+Number)}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6215}
Before\+:
...
Also note that using Type\+Script does not fix this problem for you — when libs written in {\ttfamily Type\+Script} are used from JS, or when user input ends up there — it behaves exactly as pure JS, as all type checks are translation-\/time only and are not present in the actual JS code which TS compiles to.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6216}{}\doxysubsection{Buffer(number)}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6216}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6217}{}\doxysection{Regarding Buffer.\+alloc\+Unsafe}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6217}
...
\label{_faq}%
 \hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6218}{}\doxysection{F\+AQ}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6218}
\label{_design-flaws}%
 \hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6219}{}\doxysubsection{What is wrong with the $<$tt$>$\+Buffer$<$/tt$>$ constructor?}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6219}
...
\label{_ecosystem-usage}%
 \hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6220}{}\doxysubsection{The $<$tt$>$\+Buffer()$<$/tt$>$ constructor has been deprecated for a while. Is this really an issue?}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_safer-buffer__porting-_buffer_autotoc_md6220}
