\href{https://npmjs.org/package/proxy-addr}{\texttt{ }} \href{https://npmjs.org/package/proxy-addr}{\texttt{ }} \href{https://nodejs.org/en/download}{\texttt{ }} \href{https://travis-ci.org/jshttp/proxy-addr}{\texttt{ }} \href{https://coveralls.io/r/jshttp/proxy-addr?branch=master}{\texttt{ }}

Determine address of proxied request\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_proxy-addr__r_e_a_d_m_e_autotoc_md5927}{}\doxysection{Install}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_proxy-addr__r_e_a_d_m_e_autotoc_md5927}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_proxy-addr__r_e_a_d_m_e_autotoc_md5928}{}\doxysection{A\+PI}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_proxy-addr__r_e_a_d_m_e_autotoc_md5928}

\begin{DoxyCode}{0}
\DoxyCodeLine{var proxyaddr = require('proxy-\/addr')}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_proxy-addr__r_e_a_d_m_e_autotoc_md5929}{}\doxysubsection{proxyaddr(req, trust)}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_proxy-addr__r_e_a_d_m_e_autotoc_md5929}
...
When {\ttfamily trust} is specified as a function, it will be called for each address to determine if it is a trusted address. The function is given two arguments\+: {\ttfamily addr} and {\ttfamily i}, where {\ttfamily addr} is a string of the address to check and {\ttfamily i} is a number that represents the distance from the socket address.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_proxy-addr__r_e_a_d_m_e_autotoc_md5930}{}\doxysubsection{proxyaddr.\+all(req, \mbox{[}trust\mbox{]})}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_proxy-addr__r_e_a_d_m_e_autotoc_md5930}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_proxy-addr__r_e_a_d_m_e_autotoc_md5931}{}\doxysubsection{proxyaddr.\+compile(val)}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_proxy-addr__r_e_a_d_m_e_autotoc_md5931}
...
This function is meant to be optimized for use against every request. It is recommend to compile a trust function up-\/front for the trusted configuration and pass that to {\ttfamily proxyaddr(req, trust)} for each request.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_proxy-addr__r_e_a_d_m_e_autotoc_md5932}{}\doxysection{Testing}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_proxy-addr__r_e_a_d_m_e_autotoc_md5932}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm test}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_proxy-addr__r_e_a_d_m_e_autotoc_md5933}{}\doxysection{Benchmarks}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_proxy-addr__r_e_a_d_m_e_autotoc_md5933}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm run-\/script bench}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_proxy-addr__r_e_a_d_m_e_autotoc_md5934}{}\doxysection{License}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_proxy-addr__r_e_a_d_m_e_autotoc_md5934}
