The non-\/configurable configuration loader for lazy people.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6085}{}\doxysection{Usage}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6085}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6086}{}\doxysection{Standards}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6086}
...
All configuration sources that were found will be flattened into one object, so that sources {\bfseries{earlier}} in this list override later ones.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6087}{}\doxysection{Configuration File Formats}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6087}
Configuration files (e.\+g. {\ttfamily .appnamerc}) may be in either \href{http://json.org/example}{\texttt{ json}} or \href{http://en.wikipedia.org/wiki/INI_file}{\texttt{ ini}} format. {\bfseries{No}} file extension ({\ttfamily .json} or {\ttfamily .ini}) should be used. The example configurations below are equivalent\+:\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6088}{}\doxysubsubsection{Formatted as $<$tt$>$ini$<$/tt$>$}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6088}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6089}{}\doxysubsubsection{Formatted as $<$tt$>$json$<$/tt$>$}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6089}
...
Comments are stripped from J\+S\+ON config via \href{https://github.com/sindresorhus/strip-json-comments}{\texttt{ strip-\/json-\/comments}}.

\begin{quote}
Since ini, and env variables do not have a standard for types, your application needs be prepared for strings. \end{quote}


To ensure that string representations of booleans and numbers are always converted into their proper types (especially useful if you intend to do strict {\ttfamily ===} comparisons), consider using a module such as \href{https://github.com/anselanza/parse-strings-in-object}{\texttt{ parse-\/strings-\/in-\/object}} to wrap the config object returned from rc.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6090}{}\doxysection{Simple example demonstrating precedence}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6090}
...
{\itshape Now the {\ttfamily port} comes from the {\ttfamily config.\+json} file specified (overriding the value from {\ttfamily .myapprc}), and {\ttfamily foo} value is overriden by command-\/line despite also being specified in the {\ttfamily config.\+json} file.}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6091}{}\doxysection{Advanced Usage}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6091}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6092}{}\doxysubsubsection{Pass in your own $<$tt$>$argv$<$/tt$>$}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6092}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6093}{}\doxysection{Pass in your own parser}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6093}
...
This may also be used to force a more strict format, such as strict, valid J\+S\+ON only.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6094}{}\doxysection{Note on Performance}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6094}
{\ttfamily rc} is running {\ttfamily fs.\+stat\+Sync}-- so make sure you don\textquotesingle{}t use it in a hot code path (e.\+g. a request handler)\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6095}{}\doxysection{License}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_rc__r_e_a_d_m_e_autotoc_md6095}
