...
Basic H\+T\+TP cookie parser and serializer for H\+T\+TP servers.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md746}{}\doxysection{Installation}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md746}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm install cookie}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md747}{}\doxysection{A\+PI}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md747}

\begin{DoxyCode}{0}
\DoxyCodeLine{var cookie = require('cookie');}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md748}{}\doxysubsection{cookie.\+parse(str, options)}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md748}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md749}{}\doxysubsubsection{Options}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md749}
{\ttfamily cookie.\+parse} accepts these properties in the options object.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md750}{}\doxyparagraph{decode}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md750}
...
{\bfseries{note}} if an error is thrown from this function, the original, non-\/decoded cookie value will be returned as the cookie\textquotesingle{}s value.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md751}{}\doxysubsection{cookie.\+serialize(name, value, options)}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md751}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md752}{}\doxysubsubsection{Options}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md752}
{\ttfamily cookie.\+serialize} accepts these properties in the options object.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md753}{}\doxyparagraph{domain}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md753}
Specifies the value for the \href{https://tools.ietf.org/html/rfc6265\#section-5.2.3}{\texttt{ {\ttfamily Domain} {\ttfamily Set-\/\+Cookie} attribute}}. By default, no domain is set, and most clients will consider the cookie to apply to only the current domain.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md754}{}\doxyparagraph{encode}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md754}
...
The default function is the global {\ttfamily encode\+U\+R\+I\+Component}, which will encode a Java\+Script string into U\+T\+F-\/8 byte sequences and then U\+R\+L-\/encode any that fall outside of the cookie range.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md755}{}\doxyparagraph{expires}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md755}
...
{\bfseries{note}} be careful when setting this to {\ttfamily true}, as compliant clients will not allow client-\/side Java\+Script to see the cookie in {\ttfamily document.\+cookie}.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md757}{}\doxyparagraph{max\+Age}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md757}
...
{\bfseries{note}} the \href{https://tools.ietf.org/html/rfc6265\#section-5.3}{\texttt{ cookie storage model specification}} states that if both {\ttfamily expires} and {\ttfamily max\+Age} are set, then {\ttfamily max\+Age} takes precedence, but it is possible not all clients by obey this, so if both are set, they should point to the same date and time.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md758}{}\doxyparagraph{path}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md758}
Specifies the value for the \href{https://tools.ietf.org/html/rfc6265\#section-5.2.4}{\texttt{ {\ttfamily Path} {\ttfamily Set-\/\+Cookie} attribute}}. By default, the path is considered the \href{https://tools.ietf.org/html/rfc6265\#section-5.1.4}{\texttt{ \char`\"{}default path\char`\"{}}}.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md759}{}\doxyparagraph{same\+Site}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md759}
...
{\bfseries{note}} This is an attribute that has not yet been fully standardized, and may change in the future. This also means many clients may ignore this attribute until they understand it.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md760}{}\doxyparagraph{secure}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md760}
...
{\bfseries{note}} be careful when setting this to {\ttfamily true}, as compliant clients will not send the cookie back to the server in the future if the browser does not have an H\+T\+T\+PS connection.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md761}{}\doxysection{Example}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md761}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md762}{}\doxysection{Testing}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md762}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm test}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md763}{}\doxysection{Benchmark}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md763}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md764}{}\doxysection{References}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md764}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md765}{}\doxysection{License}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_cookie__r_e_a_d_m_e_autotoc_md765}
