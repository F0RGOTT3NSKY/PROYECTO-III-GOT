\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2873}{}\doxysection{Install}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2873}
\`{}\`{}\`{}bash npm install semver \`{}\`{}\`{}\`{}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2874}{}\doxysection{Usage}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2874}
As a node module\+:
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2875}{}\doxysection{Versions}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2875}
...
A leading {\ttfamily \char`\"{}=\char`\"{}} or {\ttfamily \char`\"{}v\char`\"{}} character is stripped off and ignored.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2876}{}\doxysection{Ranges}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2876}
...
The range {\ttfamily 1.\+2.\+7 $\vert$$\vert$ $>$=1.\+2.\+9 $<$2.\+0.\+0} would match the versions {\ttfamily 1.\+2.\+7}, {\ttfamily 1.\+2.\+9}, and {\ttfamily 1.\+4.\+6}, but not the versions {\ttfamily 1.\+2.\+8} or {\ttfamily 2.\+0.\+0}.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2877}{}\doxysubsection{Prerelease Tags}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2877}
...
Note that this behavior can be suppressed (treating all prerelease versions as if they were normal versions, for the purpose of range matching) by setting the {\ttfamily include\+Prerelease} flag on the options object to any \href{https://github.com/npm/node-semver\#functions}{\texttt{ functions}} that do range matching.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2878}{}\doxysubsubsection{Prerelease Identifiers}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2878}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2879}{}\doxysubsection{Advanced Range Syntax}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2879}
Advanced range syntax desugars to primitive comparators in deterministic ways.

Advanced ranges may be combined in the same way as primitive comparators using white space or {\ttfamily $\vert$$\vert$}.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2880}{}\doxysubsubsection{Hyphen Ranges $<$tt$>$\+X.\+Y.\+Z -\/ A.\+B.\+C$<$/tt$>$}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2880}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2881}{}\doxysubsubsection{X-\/\+Ranges $<$tt$>$1.\+2.\+x$<$/tt$>$ $<$tt$>$1.\+X$<$/tt$>$ $<$tt$>$1.\+2.$\ast$$<$/tt$>$ $<$tt$>$$\ast$$<$/tt$>$}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2881}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2882}{}\doxysubsubsection{Tilde Ranges $<$tt$>$$\sim$1.\+2.\+3$<$/tt$>$ $<$tt$>$$\sim$1.\+2$<$/tt$>$ $<$tt$>$$\sim$1$<$/tt$>$}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2882}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2883}{}\doxysubsubsection{Caret Ranges $<$tt$>$$^\wedge$1.\+2.\+3$<$/tt$>$ $<$tt$>$$^\wedge$0.\+2.\+5$<$/tt$>$ $<$tt$>$$^\wedge$0.\+0.\+4$<$/tt$>$}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2883}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2884}{}\doxysubsection{Range Grammar}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2884}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2885}{}\doxysection{Functions}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2885}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2886}{}\doxysubsection{Comparison}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2886}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2887}{}\doxysubsection{Comparators}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2887}

\begin{DoxyItemize}
\item {\ttfamily intersects(comparator)}\+: Return true if the comparators intersect
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2888}{}\doxysubsection{Ranges}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2888}
...
If you want to know if a version satisfies or does not satisfy a range, use the {\ttfamily satisfies(version, range)} function.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2889}{}\doxysubsection{Coercion}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_semver-diff_node_modules_semver__r_e_a_d_m_e_autotoc_md2889}
