...
Utility to parse a string bytes (ex\+: {\ttfamily 1TB}) to bytes ({\ttfamily 1099511627776}) and vice-\/versa.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_bytes__readme_autotoc_md496}{}\doxysection{Installation}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_bytes__readme_autotoc_md496}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_bytes__readme_autotoc_md497}{}\doxysection{Usage}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_bytes__readme_autotoc_md497}

\begin{DoxyCode}{0}
\DoxyCodeLine{var bytes = require('bytes');}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_bytes__readme_autotoc_md498}{}\doxysubsubsection{bytes.\+format(number value, \mbox{[}options\mbox{]})\+: string｜null}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_bytes__readme_autotoc_md498}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_bytes__readme_autotoc_md499}{}\doxysubsubsection{bytes.\+parse(string｜number value)\+: number｜null}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_bytes__readme_autotoc_md499}
...
\DoxyCodeLine{// output: 1KB}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_bytes__readme_autotoc_md500}{}\doxysection{License}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_bytes__readme_autotoc_md500}
