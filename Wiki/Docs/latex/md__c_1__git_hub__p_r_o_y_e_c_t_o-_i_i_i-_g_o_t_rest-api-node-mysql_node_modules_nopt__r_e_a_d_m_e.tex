...
\DoxyCodeLine{}
\DoxyCodeLine{\$ node my-\/program.js -\/-\/blatzk 1000 -\/fp \# unknown opts are ok.}
\DoxyCodeLine{\{ blatzk: 1000, flag: true, pick: true \}}
\DoxyCodeLine{}
\DoxyCodeLine{\$ node my-\/program.js -\/-\/blatzk true -\/fp \# but they need a value}
...
\DoxyCodeLine{}
\DoxyCodeLine{\$ node my-\/program.js -\/-\/many 1 -\/-\/many null -\/-\/many foo}
\DoxyCodeLine{\{ many: ["1", "null", "foo"] \}}
\DoxyCodeLine{}
\DoxyCodeLine{\$ node my-\/program.js -\/-\/many foo}
\DoxyCodeLine{\{ many: ["foo"] \}}
\end{DoxyCode}


Read the tests at the bottom of {\ttfamily lib/nopt.\+js} for more examples of what this puppy can do.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_nopt__r_e_a_d_m_e_autotoc_md5680}{}\doxysubsection{Types}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_nopt__r_e_a_d_m_e_autotoc_md5680}
...
You can also call {\ttfamily nopt.\+clean(data, types, type\+Defs)} to clean up a config object and remove its invalid properties.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_nopt__r_e_a_d_m_e_autotoc_md5681}{}\doxysubsection{Error Handling}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_nopt__r_e_a_d_m_e_autotoc_md5681}
...
If no {\ttfamily nopt.\+invalid\+Handler} is assigned, then it will console.\+error its whining. If it is assigned to boolean {\ttfamily false} then the warning is suppressed.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_nopt__r_e_a_d_m_e_autotoc_md5682}{}\doxysubsection{Abbreviations}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_nopt__r_e_a_d_m_e_autotoc_md5682}
...
\DoxyCodeLine{\# etc.}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_nopt__r_e_a_d_m_e_autotoc_md5683}{}\doxysubsection{Shorthands}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_nopt__r_e_a_d_m_e_autotoc_md5683}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_nopt__r_e_a_d_m_e_autotoc_md5684}{}\doxysubsection{The Rest of the args}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_nopt__r_e_a_d_m_e_autotoc_md5684}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_nopt__r_e_a_d_m_e_autotoc_md5685}{}\doxysubsection{Slicing}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_nopt__r_e_a_d_m_e_autotoc_md5685}
