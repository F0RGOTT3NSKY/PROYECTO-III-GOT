This is an extension for node\textquotesingle{}s {\ttfamily fs.\+write\+File} that makes its operation atomic and allows you set ownership (uid/gid of the file).\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_write-file-atomic__r_e_a_d_m_e_autotoc_md3389}{}\doxysubsection{var write\+File\+Atomic = require(\textquotesingle{}write-\/file-\/atomic\textquotesingle{})$<$br$>$write\+File\+Atomic(filename, data, \mbox{[}options\mbox{]}, \mbox{[}callback\mbox{]})}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_write-file-atomic__r_e_a_d_m_e_autotoc_md3389}
...
\DoxyCodeLine{\})();}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_write-file-atomic__r_e_a_d_m_e_autotoc_md3390}{}\doxysubsection{var write\+File\+Atomic\+Sync = require(\textquotesingle{}write-\/file-\/atomic\textquotesingle{}).\+sync$<$br$>$write\+File\+Atomic\+Sync(filename, data, \mbox{[}options\mbox{]})}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_write-file-atomic__r_e_a_d_m_e_autotoc_md3390}
