...
For the current list of WG members, see the project \href{./README.md\#current-project-team-members}{\texttt{ R\+E\+A\+D\+M\+E.\+md}}.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_readable-stream__g_o_v_e_r_n_a_n_c_e_autotoc_md2711}{}\doxysubsection{Collaborators}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_readable-stream__g_o_v_e_r_n_a_n_c_e_autotoc_md2711}
...
For the current list of Collaborators, see the project \href{./README.md\#members}{\texttt{ R\+E\+A\+D\+M\+E.\+md}}.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_readable-stream__g_o_v_e_r_n_a_n_c_e_autotoc_md2712}{}\doxysubsection{W\+G Membership}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_readable-stream__g_o_v_e_r_n_a_n_c_e_autotoc_md2712}
...
No more than 1/3 of the WG members may be affiliated with the same employer. If removal or resignation of a WG member, or a change of employment by a WG member, creates a situation where more than 1/3 of the WG membership shares an employer, then the situation must be immediately remedied by the resignation or removal of one or more WG members affiliated with the over-\/represented employer(s).\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_readable-stream__g_o_v_e_r_n_a_n_c_e_autotoc_md2713}{}\doxysubsection{W\+G Meetings}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_readable-stream__g_o_v_e_r_n_a_n_c_e_autotoc_md2713}
...
The moderator is responsible for summarizing the discussion of each agenda item and sends it as a pull request after the meeting.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_readable-stream__g_o_v_e_r_n_a_n_c_e_autotoc_md2714}{}\doxysubsection{Consensus Seeking Process}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_readable-stream__g_o_v_e_r_n_a_n_c_e_autotoc_md2714}
