...
This module generates H\+T\+TP E\+Tags (as defined in R\+FC 7232) for use in H\+T\+TP responses.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_etag__r_e_a_d_m_e_autotoc_md4377}{}\doxysection{Installation}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_etag__r_e_a_d_m_e_autotoc_md4377}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_etag__r_e_a_d_m_e_autotoc_md4378}{}\doxysection{A\+PI}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_etag__r_e_a_d_m_e_autotoc_md4378}

\begin{DoxyCode}{0}
\DoxyCodeLine{var etag = require('etag')}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_etag__r_e_a_d_m_e_autotoc_md4379}{}\doxysubsection{etag(entity, \mbox{[}options\mbox{]})}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_etag__r_e_a_d_m_e_autotoc_md4379}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_etag__r_e_a_d_m_e_autotoc_md4380}{}\doxysubsubsection{Options}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_etag__r_e_a_d_m_e_autotoc_md4380}
{\ttfamily etag} accepts these properties in the options object.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_etag__r_e_a_d_m_e_autotoc_md4381}{}\doxyparagraph{weak}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_etag__r_e_a_d_m_e_autotoc_md4381}
Specifies if the generated E\+Tag will include the weak validator mark (that is, the leading {\ttfamily W/}). The actual entity tag is the same. The default value is {\ttfamily false}, unless the {\ttfamily entity} is {\ttfamily fs.\+Stats}, in which case it is {\ttfamily true}.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_etag__r_e_a_d_m_e_autotoc_md4382}{}\doxysection{Testing}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_etag__r_e_a_d_m_e_autotoc_md4382}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm test}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_etag__r_e_a_d_m_e_autotoc_md4383}{}\doxysection{Benchmark}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_etag__r_e_a_d_m_e_autotoc_md4383}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_etag__r_e_a_d_m_e_autotoc_md4384}{}\doxysection{License}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_etag__r_e_a_d_m_e_autotoc_md4384}
