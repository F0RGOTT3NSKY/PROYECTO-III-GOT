...
Keyv provides a consistent interface for key-\/value storage across multiple backends via storage adapters. It supports T\+TL based expiry, making it suitable as a cache or a persistent key-\/value store.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1692}{}\doxysubsection{Features}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1692}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1693}{}\doxysubsection{Usage}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1693}
Install Keyv.
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1694}{}\doxysubsubsection{Namespaces}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1694}
...
\DoxyCodeLine{await cache.get('foo'); // 'cache'}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1695}{}\doxysubsubsection{Custom Serializers}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1695}
...
{\bfseries{Warning\+:}} Using custom serializers means you lose any guarantee of data consistency. You should do extensive testing with your serialisation functions and chosen storage engine.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1696}{}\doxysubsection{Official Storage Adapters}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1696}
...
\end{longtabu}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1697}{}\doxysubsection{Third-\/party Storage Adapters}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1697}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1698}{}\doxysubsection{Add Cache Support to your Module}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1698}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1699}{}\doxysubsection{A\+PI}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1699}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1700}{}\doxysubsubsection{new Keyv(\mbox{[}uri\mbox{]}, \mbox{[}options\mbox{]})}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1700}
Returns a new Keyv instance.

The Keyv instance is also an {\ttfamily Event\+Emitter} that will emit an `\textquotesingle{}error'\`{} event if the storage adapter connection fails.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1701}{}\doxysubsubsection{uri}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1701}
Type\+: {\ttfamily String}~\newline
 Default\+: {\ttfamily undefined}

The connection string U\+RI.

Merged into the options object as options.\+uri.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1702}{}\doxysubsubsection{options}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1702}
Type\+: {\ttfamily Object}

The options object is also passed through to the storage adapter. Check your storage adapter docs for any extra options.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1703}{}\doxyparagraph{options.\+namespace}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1703}
Type\+: {\ttfamily String}~\newline
 Default\+: `\textquotesingle{}keyv'\`{}

Namespace for the current instance.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1704}{}\doxyparagraph{options.\+ttl}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1704}
Type\+: {\ttfamily Number}~\newline
 Default\+: {\ttfamily undefined}

Default T\+TL. Can be overridden by specififying a T\+TL on {\ttfamily .set()}.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1705}{}\doxyparagraph{options.\+serialize}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1705}
Type\+: {\ttfamily Function}~\newline
 Default\+: {\ttfamily J\+S\+O\+N\+B.\+stringify}

A custom serialization function.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1706}{}\doxyparagraph{options.\+deserialize}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1706}
Type\+: {\ttfamily Function}~\newline
 Default\+: {\ttfamily J\+S\+O\+N\+B.\+parse}

A custom deserialization function.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1707}{}\doxyparagraph{options.\+store}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1707}
Type\+: {\ttfamily Storage adapter instance}~\newline
 Default\+: {\ttfamily new Map()}

The storage adapter instance to be used by Keyv.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1708}{}\doxyparagraph{options.\+adapter}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1708}
Type\+: {\ttfamily String}~\newline
 Default\+: {\ttfamily undefined}

Specify an adapter to use. e.\+g `\textquotesingle{}redis'{\ttfamily or}\textquotesingle{}mongodb\textquotesingle{}\`{}.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1709}{}\doxysubsubsection{Instance}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1709}
Keys must always be strings. Values can be of any type.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1710}{}\doxyparagraph{.\+set(key, value, \mbox{[}ttl\mbox{]})}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1710}
Set a value.

By default keys are persistent. You can set an expiry T\+TL in milliseconds.

Returns {\ttfamily true}.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1711}{}\doxyparagraph{.\+get(key)}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1711}
Returns the value.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1712}{}\doxyparagraph{.\+delete(key)}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1712}
Deletes an entry.

Returns {\ttfamily true} if the key existed, {\ttfamily false} if not.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1713}{}\doxyparagraph{.\+clear()}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1713}
Delete all entries in the current namespace.

Returns {\ttfamily undefined}.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1714}{}\doxysubsection{License}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e_autotoc_md1714}
M\+IT © Luke Childs 