...
The improvements are meant to normalize behavior across different platforms and environments, and to make filesystem access more resilient to errors.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1448}{}\doxysection{Improvements over $<$a href=\char`\"{}https\+://nodejs.\+org/api/fs.\+html\char`\"{}$>$fs module$<$/a$>$}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1448}
...
On Windows, it retries renaming a file for up to one second if {\ttfamily E\+A\+C\+C\+E\+SS} or {\ttfamily E\+P\+E\+RM} error occurs, likely because antivirus software has locked the directory.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1449}{}\doxysection{U\+S\+A\+GE}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1449}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1450}{}\doxysection{Global Patching}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1450}
...
This should only ever be done at the top-\/level application layer, in order to delay on E\+M\+F\+I\+LE errors from any fs-\/using dependencies. You should {\bfseries{not}} do this in a library, because it can cause unexpected delays in other parts of the program.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1451}{}\doxysection{Changes}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1451}
...
The current approach loads the {\ttfamily fs} module, and then creates a lookalike object that has all the same methods, except a few that are patched. It is safe to use in all versions of Node from 0.\+8 through 7.\+0.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1452}{}\doxysubsection{v4}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1452}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1453}{}\doxysubsection{v3}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1453}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1454}{}\doxysubsection{v2.\+1.\+0}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1454}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1455}{}\doxysubsection{v2.\+0}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1455}

\begin{DoxyItemize}
\item A return to monkey patching
\item wrap process.\+cwd
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1456}{}\doxysubsection{v1.\+1}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1456}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1457}{}\doxysubsection{1.\+0}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_graceful-fs__r_e_a_d_m_e_autotoc_md1457}
