\begin{quote}
Recursive version of \href{https://nodejs.org/api/fs.html\#fs_fs_readdir_path_options_callback}{\texttt{ fs.\+readdir}}. Exposes a {\bfseries{stream A\+PI}} and a {\bfseries{promise A\+PI}}. \end{quote}


\href{https://www.npmjs.com/package/readdirp}{\texttt{ }}
...
For more examples, check out {\ttfamily examples} directory.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_readdirp__r_e_a_d_m_e_autotoc_md6116}{}\doxysection{A\+PI}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_readdirp__r_e_a_d_m_e_autotoc_md6116}
{\ttfamily const stream = readdirp(root\mbox{[}, options\mbox{]})} — {\bfseries{Stream A\+PI}}


\begin{DoxyItemize}
\item Reads given root recursively and returns a {\ttfamily stream} of \href{\#entryinfo}{\texttt{ entry infos}}
...
{\ttfamily const entries = await readdirp.\+promise(root\mbox{[}, options\mbox{]})} — {\bfseries{Promise A\+PI}}. Returns a list of \href{\#entryinfo}{\texttt{ entry infos}}.

First argument is awalys {\ttfamily root}, path in which to start reading and recursing into subdirectories.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_readdirp__r_e_a_d_m_e_autotoc_md6117}{}\doxysubsection{options}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_readdirp__r_e_a_d_m_e_autotoc_md6117}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_readdirp__r_e_a_d_m_e_autotoc_md6118}{}\doxysubsection{$<$tt$>$\+Entry\+Info$<$/tt$>$}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_readdirp__r_e_a_d_m_e_autotoc_md6118}
Has the following properties\+:


\begin{DoxyItemize}
\item `path\+: \textquotesingle{}assets/javascripts/react.\+js'{\ttfamily \+: path to the file/directory (relative to given root) -\/}full\+Path\+: \textquotesingle{}/\+Users/dev/projects/app/assets/javascripts/react.js\textquotesingle{}{\ttfamily \+: full path to the file/directory found -\/}basename\+: \textquotesingle{}react.\+js\textquotesingle{}{\ttfamily \+: name of the file/directory -\/}dirent\+: fs.\+Dirent$<$tt$>$\+: built-\/in \mbox{[}dir entry object\mbox{]}(\href{https://nodejs.org/api/fs.html}{\texttt{ https\+://nodejs.\+org/api/fs.\+html}}\#fs\+\_\+class\+\_\+fs\+\_\+dirent) -\/ only withalways\+Stat\+: false{\ttfamily  -\/}stats\+: fs.\+Stats$<$tt$>$\+: built in \mbox{[}stat object\mbox{]}(\href{https://nodejs.org/api/fs.html}{\texttt{ https\+://nodejs.\+org/api/fs.\+html}}\#fs\+\_\+class\+\_\+fs\+\_\+stats) -\/ only withalways\+Stat\+: true\`{}
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_readdirp__r_e_a_d_m_e_autotoc_md6119}{}\doxysection{Changelog}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_readdirp__r_e_a_d_m_e_autotoc_md6119}

\begin{DoxyItemize}
\item 3.\+3 (Dec 6, 2019) stabilizes R\+AM consumption and enables perf management with {\ttfamily high\+Water\+Mark} option. Fixes race conditions related to {\ttfamily for-\/await} looping.
...
{\ttfamily {\ttfamily }}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_readdirp__r_e_a_d_m_e_autotoc_md6120}{}\doxysection{License}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_readdirp__r_e_a_d_m_e_autotoc_md6120}
{\ttfamily {\ttfamily  Copyright (c) 2012-\/2019 Thorsten Lorenz, Paul Miller (\href{https://paulmillr.com}{\texttt{ https\+://paulmillr.\+com}})}}

{\ttfamily {\ttfamily M\+IT License, see \mbox{[}L\+I\+C\+E\+N\+SE\mbox{]}(L\+I\+C\+E\+N\+SE) file. }}