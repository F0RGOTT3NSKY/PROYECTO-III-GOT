...
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md886}{}\doxysection{Install}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md886}
...
This module can also be bundled with systems like \href{http://browserify.org/}{\texttt{ Browserify}} or \href{https://webpack.github.io/}{\texttt{ webpack}}, though by default this module will alter it\textquotesingle{}s A\+PI to no longer display or track deprecations.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md887}{}\doxysection{A\+PI}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md887}
...
{\bfseries{N\+O\+TE}} this library has a similar interface to the {\ttfamily debug} module, and this module uses the calling file to get the boundary for the call stacks, so you should always create a new {\ttfamily deprecate} object in each file and not within some central file.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md888}{}\doxysubsection{depd(namespace)}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md888}
Create a new deprecate function that uses the given namespace name in the messages and will display the call site prior to the stack entering the file this function was called from. It is highly suggested you use the name of your module as the namespace.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md889}{}\doxysubsection{deprecate(message)}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md889}
...
If the message is omitted, a message is generated for you based on the site of the {\ttfamily deprecate()} call and will display the name of the function called, similar to the name displayed in a stack trace.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md890}{}\doxysubsection{deprecate.\+function(fn, message)}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md890}
Call this function to wrap a given function in a deprecation message on any call to the function. An optional message can be supplied to provide a custom message.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md891}{}\doxysubsection{deprecate.\+property(obj, prop, message)}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md891}
...
If the property is a data descriptor, it will be converted to an accessor descriptor in order to display the deprecation message.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md892}{}\doxysubsection{process.\+on(\textquotesingle{}deprecation\textquotesingle{}, fn)}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md892}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md893}{}\doxysubsection{process.\+env.\+N\+O\+\_\+\+D\+E\+P\+R\+E\+C\+A\+T\+I\+ON}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md893}
...
{\bfseries{N\+O\+TE}} This will not suppress the deperecations given to any \char`\"{}deprecation\char`\"{} event listeners, just the output to S\+T\+D\+E\+RR.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md894}{}\doxysubsection{process.\+env.\+T\+R\+A\+C\+E\+\_\+\+D\+E\+P\+R\+E\+C\+A\+T\+I\+ON}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md894}
...
{\bfseries{N\+O\+TE}} This will not trace the deperecations silenced by {\ttfamily N\+O\+\_\+\+D\+E\+P\+R\+E\+C\+A\+T\+I\+ON}.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md895}{}\doxysection{Display}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md895}
...
\DoxyCodeLine{                                             the word "deprecated"}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md896}{}\doxysection{Examples}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md896}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md897}{}\doxysubsection{Deprecating all calls to a function}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md897}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md898}{}\doxysubsection{Conditionally deprecating a function call}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md898}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md899}{}\doxysubsection{Deprecating property access}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md899}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md900}{}\doxysection{License}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_depd__readme_autotoc_md900}
