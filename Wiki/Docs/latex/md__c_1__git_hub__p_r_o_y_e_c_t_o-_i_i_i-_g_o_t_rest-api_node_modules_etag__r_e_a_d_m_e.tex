...
This module generates H\+T\+TP E\+Tags (as defined in R\+FC 7232) for use in H\+T\+TP responses.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_etag__r_e_a_d_m_e_autotoc_md980}{}\doxysection{Installation}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_etag__r_e_a_d_m_e_autotoc_md980}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_etag__r_e_a_d_m_e_autotoc_md981}{}\doxysection{A\+PI}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_etag__r_e_a_d_m_e_autotoc_md981}

\begin{DoxyCode}{0}
\DoxyCodeLine{var etag = require('etag')}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_etag__r_e_a_d_m_e_autotoc_md982}{}\doxysubsection{etag(entity, \mbox{[}options\mbox{]})}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_etag__r_e_a_d_m_e_autotoc_md982}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_etag__r_e_a_d_m_e_autotoc_md983}{}\doxysubsubsection{Options}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_etag__r_e_a_d_m_e_autotoc_md983}
{\ttfamily etag} accepts these properties in the options object.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_etag__r_e_a_d_m_e_autotoc_md984}{}\doxyparagraph{weak}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_etag__r_e_a_d_m_e_autotoc_md984}
Specifies if the generated E\+Tag will include the weak validator mark (that is, the leading {\ttfamily W/}). The actual entity tag is the same. The default value is {\ttfamily false}, unless the {\ttfamily entity} is {\ttfamily fs.\+Stats}, in which case it is {\ttfamily true}.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_etag__r_e_a_d_m_e_autotoc_md985}{}\doxysection{Testing}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_etag__r_e_a_d_m_e_autotoc_md985}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm test}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_etag__r_e_a_d_m_e_autotoc_md986}{}\doxysection{Benchmark}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_etag__r_e_a_d_m_e_autotoc_md986}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_etag__r_e_a_d_m_e_autotoc_md987}{}\doxysection{License}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_etag__r_e_a_d_m_e_autotoc_md987}
