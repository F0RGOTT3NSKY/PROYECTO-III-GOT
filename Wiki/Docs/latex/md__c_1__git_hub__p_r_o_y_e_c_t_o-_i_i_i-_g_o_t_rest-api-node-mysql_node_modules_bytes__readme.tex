...
Utility to parse a string bytes (ex\+: {\ttfamily 1TB}) to bytes ({\ttfamily 1099511627776}) and vice-\/versa.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_bytes__readme_autotoc_md3893}{}\doxysection{Installation}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_bytes__readme_autotoc_md3893}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_bytes__readme_autotoc_md3894}{}\doxysection{Usage}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_bytes__readme_autotoc_md3894}

\begin{DoxyCode}{0}
\DoxyCodeLine{var bytes = require('bytes');}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_bytes__readme_autotoc_md3895}{}\doxysubsubsection{bytes.\+format(number value, \mbox{[}options\mbox{]})\+: string｜null}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_bytes__readme_autotoc_md3895}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_bytes__readme_autotoc_md3896}{}\doxysubsubsection{bytes.\+parse(string｜number value)\+: number｜null}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_bytes__readme_autotoc_md3896}
...
\DoxyCodeLine{// output: 1KB}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_bytes__readme_autotoc_md3897}{}\doxysection{License}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_bytes__readme_autotoc_md3897}
