...
Get the first event in a set of event emitters and event pairs, then clean up after itself.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_ee-first__r_e_a_d_m_e_autotoc_md927}{}\doxysection{Install}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_ee-first__r_e_a_d_m_e_autotoc_md927}

\begin{DoxyCode}{0}
\DoxyCodeLine{\$ npm install ee-\/first}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_ee-first__r_e_a_d_m_e_autotoc_md928}{}\doxysection{A\+PI}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_ee-first__r_e_a_d_m_e_autotoc_md928}

\begin{DoxyCode}{0}
\DoxyCodeLine{var first = require('ee-\/first')}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_ee-first__r_e_a_d_m_e_autotoc_md929}{}\doxysubsection{first(arr, listener)}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_ee-first__r_e_a_d_m_e_autotoc_md929}
...
\DoxyCodeLine{\})}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_ee-first__r_e_a_d_m_e_autotoc_md930}{}\doxysubsubsection{.\+cancel()}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_ee-first__r_e_a_d_m_e_autotoc_md930}
