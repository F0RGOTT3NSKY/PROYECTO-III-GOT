\href{https://travis-ci.org/ljharb/qs}{\texttt{ }} \href{https://david-dm.org/ljharb/qs}{\texttt{ }} \href{https://david-dm.org/ljharb/qs?type=dev}{\texttt{ }} \mbox{[}\mbox{]}\mbox{[}license-\/url\mbox{]} \href{http://npm-stat.com/charts.html?package=qs}{\texttt{ }}
...
The {\bfseries{qs}} module was originally created and maintained by \href{https://github.com/visionmedia/node-querystring}{\texttt{ TJ Holowaychuk}}.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_qs__r_e_a_d_m_e_autotoc_md6001}{}\doxysection{Usage}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_qs__r_e_a_d_m_e_autotoc_md6001}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_qs__r_e_a_d_m_e_autotoc_md6002}{}\doxysubsection{Parsing Objects}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_qs__r_e_a_d_m_e_autotoc_md6002}
...
It also works when the charset has been detected in {\ttfamily charset\+Sentinel} mode.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_qs__r_e_a_d_m_e_autotoc_md6003}{}\doxysubsection{Parsing Arrays}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_qs__r_e_a_d_m_e_autotoc_md6003}
...
({\itshape this cannot convert nested objects, such as {\ttfamily a=\{b\+:1\},\{c\+:d\}}})\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_qs__r_e_a_d_m_e_autotoc_md6004}{}\doxysubsection{Stringifying}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_qs__r_e_a_d_m_e_autotoc_md6004}
\mbox{[}\mbox{]}(\#prevent\+Eval) 
\begin{DoxyCode}{0}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{Examples beyond this point will be shown as though the output is not URI encoded for clarity. Please note that the return values in these cases *will* be URI encoded during real usage.}
\DoxyCodeLine{}
\DoxyCodeLine{When arrays are stringified, by default they are given explicit indices:}
\DoxyCodeLine{}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_qs__r_e_a_d_m_e_autotoc_md6005}{}\doxysubsection{Handling of $<$tt$>$null$<$/tt$>$ values}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_qs__r_e_a_d_m_e_autotoc_md6005}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_qs__r_e_a_d_m_e_autotoc_md6006}{}\doxysubsection{Dealing with special character sets}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_qs__r_e_a_d_m_e_autotoc_md6006}
...
If you wish to encode querystrings to a different character set (i.\+e. \href{https://en.wikipedia.org/wiki/Shift_JIS}{\texttt{ Shift J\+IS}}) you can use the \href{https://github.com/martinheidegger/qs-iconv}{\texttt{ {\ttfamily qs-\/iconv}}} library\+:
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_qs__r_e_a_d_m_e_autotoc_md6007}{}\doxysubsection{R\+F\+C 3986 and R\+F\+C 1738 space encoding}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_qs__r_e_a_d_m_e_autotoc_md6007}
