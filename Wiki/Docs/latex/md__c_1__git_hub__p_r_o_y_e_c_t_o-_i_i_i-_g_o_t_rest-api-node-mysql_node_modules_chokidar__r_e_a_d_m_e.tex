...
\href{https://www.npmjs.com/package/chokidar}{\texttt{ }}

Version 3 is out! Check out our blog post about it\+: \href{https://paulmillr.com/posts/chokidar-3-save-32tb-of-traffic/}{\texttt{ Chokidar 3\+: How to save 32TB of traffic every week}}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3989}{}\doxysection{Why?}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3989}
...
Initially made for {\bfseries{\href{https://brunch.io/}{\texttt{ Brunch}}}} (an ultra-\/swift web app build tool), it is now used in \href{https://github.com/microsoft/vscode}{\texttt{ Microsoft\textquotesingle{}s Visual Studio Code}}, \href{https://github.com/gulpjs/gulp/}{\texttt{ gulp}}, \href{https://karma-runner.github.io/}{\texttt{ karma}}, \href{https://github.com/Unitech/PM2}{\texttt{ P\+M2}}, \href{http://browserify.org/}{\texttt{ browserify}}, \href{https://webpack.github.io/}{\texttt{ webpack}}, \href{https://www.browsersync.io/}{\texttt{ Browser\+Sync}}, and \href{https://www.npmjs.com/browse/depended/chokidar}{\texttt{ many others}}. It has proven itself in production environments.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3990}{}\doxysection{How?}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3990}
...
On other platforms, the {\ttfamily fs.\+watch}-\/based implementation is the default, which avoids polling and keeps C\+PU usage down. Be advised that chokidar will initiate watchers recursively for everything within scope of the paths that have been specified, so be judicious about not wasting system resources by watching much more than needed.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3991}{}\doxysection{Getting started}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3991}
Install with npm\+:
...
\DoxyCodeLine{\});}
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3992}{}\doxysection{A\+PI}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3992}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3993}{}\doxysubsubsection{Persistence}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3993}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3994}{}\doxysubsubsection{Path filtering}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3994}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3995}{}\doxysubsubsection{Performance}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3995}
...
\begin{DoxyItemize}
\item {\ttfamily interval} (default\+: {\ttfamily 100}). Interval of file system polling, in milliseconds. You may also set the C\+H\+O\+K\+I\+D\+A\+R\+\_\+\+I\+N\+T\+E\+R\+V\+AL env variable to override this option.
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3996}{}\doxysubsubsection{Errors}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3996}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3997}{}\doxysubsection{Methods \& Events}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3997}
...
\item {\ttfamily .unwatch(path / paths)}\+: Stop watching files, directories, or glob patterns. Takes an array of strings or just one string. Use with {\ttfamily await} to ensure bugs don\textquotesingle{}t happen.
\item {\ttfamily .close()}\+: {\bfseries{async}} Removes all listeners from watched files. Asynchronous, returns Promise.
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3998}{}\doxysection{C\+LI}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3998}
If you need a C\+LI interface for your file watching, check out \href{https://github.com/kimmobrunfeldt/chokidar-cli}{\texttt{ chokidar-\/cli}}, allowing you to execute a command on each change, or get a stdio stream of change events.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3999}{}\doxysection{Install Troubleshooting}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md3999}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md4000}{}\doxysection{Changelog}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md4000}
For more detailed changelog, see \`{}full\+\_\+changelog.md\`{}.
\begin{DoxyItemize}
\item {\bfseries{v3.\+4 (Apr 26, 2020)\+:}} Support for directory-\/based symlinks. Macos file replacement fixes.
\item {\bfseries{v3.\+3 (Nov 2, 2019)\+:}} {\ttfamily F\+S\+Watcher\#close()} method became async. That fixes IO race conditions related to close method.
\item {\bfseries{v3.\+2 (Oct 1, 2019)\+:}} Improve Linux R\+AM usage by 50\%. Race condition fixes. Windows glob fixes. Improve stability by using tight range of dependency versions.
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md4001}{}\doxysection{Also}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md4001}
Why was chokidar named this way? What\textquotesingle{}s the meaning behind it?

$>$Chowkidar is a transliteration of a Hindi word meaning \textquotesingle{}watchman, gatekeeper\textquotesingle{}, चौकीदार. This ultimately comes from Sanskrit \+\_\+ चतुष्क\+\_\+ (crossway, quadrangle, consisting-\/of-\/four).\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md4002}{}\doxysection{License}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api-node-mysql_node_modules_chokidar__r_e_a_d_m_e_autotoc_md4002}
M\+IT (c) Paul Miller (\href{https://paulmillr.com}{\texttt{ https\+://paulmillr.\+com}}), see \mbox{[}L\+I\+C\+E\+N\+SE\mbox{]}(L\+I\+C\+E\+N\+SE) file. 