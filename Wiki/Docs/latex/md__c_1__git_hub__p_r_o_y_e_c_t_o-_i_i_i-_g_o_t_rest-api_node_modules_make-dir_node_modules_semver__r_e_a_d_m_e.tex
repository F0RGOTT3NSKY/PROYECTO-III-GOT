\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1741}{}\doxysection{Install}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1741}
\`{}\`{}\`{}bash npm install semver \`{}\`{}\`{}\`{}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1742}{}\doxysection{Usage}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1742}
As a node module\+:
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1743}{}\doxysection{Versions}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1743}
...
A leading {\ttfamily \char`\"{}=\char`\"{}} or {\ttfamily \char`\"{}v\char`\"{}} character is stripped off and ignored.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1744}{}\doxysection{Ranges}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1744}
...
The range {\ttfamily 1.\+2.\+7 $\vert$$\vert$ $>$=1.\+2.\+9 $<$2.\+0.\+0} would match the versions {\ttfamily 1.\+2.\+7}, {\ttfamily 1.\+2.\+9}, and {\ttfamily 1.\+4.\+6}, but not the versions {\ttfamily 1.\+2.\+8} or {\ttfamily 2.\+0.\+0}.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1745}{}\doxysubsection{Prerelease Tags}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1745}
...
Note that this behavior can be suppressed (treating all prerelease versions as if they were normal versions, for the purpose of range matching) by setting the {\ttfamily include\+Prerelease} flag on the options object to any \href{https://github.com/npm/node-semver\#functions}{\texttt{ functions}} that do range matching.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1746}{}\doxysubsubsection{Prerelease Identifiers}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1746}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1747}{}\doxysubsection{Advanced Range Syntax}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1747}
Advanced range syntax desugars to primitive comparators in deterministic ways.

Advanced ranges may be combined in the same way as primitive comparators using white space or {\ttfamily $\vert$$\vert$}.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1748}{}\doxysubsubsection{Hyphen Ranges $<$tt$>$\+X.\+Y.\+Z -\/ A.\+B.\+C$<$/tt$>$}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1748}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1749}{}\doxysubsubsection{X-\/\+Ranges $<$tt$>$1.\+2.\+x$<$/tt$>$ $<$tt$>$1.\+X$<$/tt$>$ $<$tt$>$1.\+2.$\ast$$<$/tt$>$ $<$tt$>$$\ast$$<$/tt$>$}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1749}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1750}{}\doxysubsubsection{Tilde Ranges $<$tt$>$$\sim$1.\+2.\+3$<$/tt$>$ $<$tt$>$$\sim$1.\+2$<$/tt$>$ $<$tt$>$$\sim$1$<$/tt$>$}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1750}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1751}{}\doxysubsubsection{Caret Ranges $<$tt$>$$^\wedge$1.\+2.\+3$<$/tt$>$ $<$tt$>$$^\wedge$0.\+2.\+5$<$/tt$>$ $<$tt$>$$^\wedge$0.\+0.\+4$<$/tt$>$}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1751}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1752}{}\doxysubsection{Range Grammar}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1752}
...
\end{DoxyCode}
\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1753}{}\doxysection{Functions}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1753}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1754}{}\doxysubsection{Comparison}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1754}
...
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1755}{}\doxysubsection{Comparators}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1755}

\begin{DoxyItemize}
\item {\ttfamily intersects(comparator)}\+: Return true if the comparators intersect
\end{DoxyItemize}\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1756}{}\doxysubsection{Ranges}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1756}
...
If you want to know if a version satisfies or does not satisfy a range, use the {\ttfamily satisfies(version, range)} function.\hypertarget{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1757}{}\doxysubsection{Coercion}\label{md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_make-dir_node_modules_semver__r_e_a_d_m_e_autotoc_md1757}
