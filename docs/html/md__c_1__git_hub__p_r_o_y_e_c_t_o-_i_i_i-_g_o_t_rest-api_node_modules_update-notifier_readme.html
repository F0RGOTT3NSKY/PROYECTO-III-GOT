...
<title>GOT: update-notifier &lt;a href=&quot;https://travis-ci.org/yeoman/update-notifier&quot;&gt;&lt;img src=&quot;https://travis-ci.org/yeoman/update-notifier.svg?branch=master&quot; alt=&quot;Build Status&quot;/&gt;&lt;/a&gt;</title>
...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_update-notifier_readme.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div class="title">update-notifier <a href="https://travis-ci.org/yeoman/update-notifier"><img src="https://travis-ci.org/yeoman/update-notifier.svg?branch=master" alt="Build Status" style="pointer-events: none;" class="inline"/></a> </div>  </div>
</div><!--header-->
<div class="contents">
...
</div><!-- fragment --><h1><a class="anchor" id="autotoc_md3355"></a>
Usage</h1>
...
<div class="line">}</div>
<div class="line">*/</div>
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md3358"></a>
...
pkg</h3>
<p>Type: <code>object</code></p>
<h4><a class="anchor" id="autotoc_md3364"></a>
name</h4>
<p><em>Required</em>\ Type: <code>string</code></p>
<h4><a class="anchor" id="autotoc_md3365"></a>
version</h4>
<p><em>Required</em>\ Type: <code>string</code></p>
<h3><a class="anchor" id="autotoc_md3366"></a>
updateCheckInterval</h3>
<p>Type: <code>number</code>\ Default: <code>1000 * 60 * 60 * 24</code> *(1 day)*</p>
...
<ul>
<li><code>latest</code> _(String)_ - Latest version.</li>
<li><code>current</code> _(String)_ - Current version.</li>
<li><code>type</code> _(String)_ - Type of current update. Possible values: <code>latest</code>, <code>major</code>, <code>minor</code>, <code>patch</code>, <code>prerelease</code>, <code>build</code>.</li>
<li><code>name</code> _(String)_ - Package name.</li>
</ul>
...
</div><!-- fragment --><h4><a class="anchor" id="autotoc_md3374"></a>
isGlobal</h4>
...
<h4><a class="anchor" id="autotoc_md3375"></a>
boxenOptions</h4>
<p>Type: <code>object</code>\ Default: &lsquo;{padding: 1, margin: 1, align: 'center&rsquo;, borderColor: 'yellow', borderStyle: 'round'}` *(See screenshot)*</p>
