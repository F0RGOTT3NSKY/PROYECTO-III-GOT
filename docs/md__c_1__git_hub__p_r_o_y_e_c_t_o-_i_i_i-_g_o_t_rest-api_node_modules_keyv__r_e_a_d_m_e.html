...
<script type="text/javascript">
/* @license magnet:?xt=urn:btih:cf05388f2679ee054f2beb29a391d25f4e673ac3&amp;dn=gpl-2.0.txt GPL-v2 */
$(document).ready(function(){initNavTree('md__c_1__git_hub__p_r_o_y_e_c_t_o-_i_i_i-_g_o_t_rest-api_node_modules_keyv__r_e_a_d_m_e.html',''); initResizable(); });
/* @license-end */
</script>
<div id="doc-content">
...
<div class="line">await cache.get(&#39;foo&#39;); // &#39;cache&#39;</div>
</div><!-- fragment --><h3><a class="anchor" id="autotoc_md1695"></a>
...
</div><!-- fragment --><h2><a class="anchor" id="autotoc_md1699"></a>
API</h2>
...
<h4><a class="anchor" id="autotoc_md1710"></a>
...
<h4><a class="anchor" id="autotoc_md1711"></a>
.get(key)</h4>
<p>Returns the value.</p>
<h4><a class="anchor" id="autotoc_md1712"></a>
.delete(key)</h4>
<p>Deletes an entry.</p>
<p>Returns <code>true</code> if the key existed, <code>false</code> if not.</p>
<h4><a class="anchor" id="autotoc_md1713"></a>
.clear()</h4>
